Welcome to my React100 Hackathon project! After a lot of issues relating to finding APIs that actually work, I decided to make a map of crimes committed in a few selected areas.

To get the project up and running, follow the instructions in the Usage and Installation sections. Everything else here is for troubleshooting purposes.
